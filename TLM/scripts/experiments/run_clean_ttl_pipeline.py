...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the clean AdaptEval offline TTL baseline, then evaluate clean accuracy and the unified safety suite."
    )
...
def main() -> None:
    ...
    experiment_name = f"clean_{args.dataset}_offline_ttl"
    ...
    clean_eval_json = metrics_dir / "clean_eval.json"
